...
(function(root) {
  var Backbone, Collection, Events, Model, eventSplitter, eventsApi, extend, listenMethods, methodMap, previousBackbone, push, slice, splice, triggerEvents, urlError, wrapError, _;
  ...
  Collection = Backbone.Collection = (function() {
    ...
    Collection.prototype.add = function(models, options) {
      var add, at, attrs, doSort, existing, model, modelMap, remove, sort, sortAttr, _i, _j, _k, _len, _len1, _len2;
      if (options == null) {
        options = {};
      }
    ...
    Collection.prototype.add = function(models, options) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        _results.push(this.models.push(model));
      }
      return _results;
    };
