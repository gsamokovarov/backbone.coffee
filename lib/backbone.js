(function() {
  ...
  (function(root) {
    var Backbone, Collection, Events, History, Model, Router, View, eventSplitter, eventsApi, extend, listenMethods, methodMap, previousBackbone, push, slice, splice, triggerEvents, urlError, wrapError, _;
    ...
    Model = Backbone.Model = (function() {
      ...
      Model.prototype.set = function(key, val, options) {
        var attr, attrs, change, changes, changing, current, prev, unset, _i, _len, _ref, _ref1;
        if (key == null) {
          return this;
        }
    ...
    History = Backbone.History = (function() {
      var isExplorer, rootStripper, routeStripper, trailingSlash;
      ...
      History.prototype.getHash = function(window) {
        var _ref;
        return ((_ref = (window || this).location.href.match(/#(.*)$/)) != null ? _ref[1] : void 0) || '';
      };
    ...
    View = Backbone.View = (function() {
      var delegateEventSplitter, viewOptions;
