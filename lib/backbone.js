...
(function(root) {
  var Backbone, Collection, Events, History, Model, Router, attributeMethods, escapeRegExp, eventSplitter, eventsApi, extend, isExplorer, listenMethods, methodMap, methods, namedParam, optionalParam, previousBackbone, push, rootStripper, routeStripper, slice, splatParam, splice, trailingSlash, triggerEvents, urlError, wrapError, _;
  ...
  History = Backbone.History = (function() {
    ...
    History.prototype.start = function(options) {
      ...
      if (this._wantsHashChange && this._wantsPushState && !this._hasPushState && !atRoot) {
        ...
        this.istory.replaceState({}, document.title, this.root + this.fragment + loc.search);
      }
